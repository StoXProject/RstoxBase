...
#' @param TargetVariableUnit The unit to use for the \code{TargetVariable}. Run the following in R to see possible units: \code{RstoxData::StoxUnits} (look for the appropriate quantity, e.g. "length" for IndividualTotalLength, and use the shortname in the \code{TargetVariableUnit}).
