...
utils::globalVariables(c(
	 ...
	 "CatchFractionCount", "CatchFractionWeight", "ChannelReferenceDepth",
	 "ChannelReferenceOrientation", "Cruise", "DateTime", "Density", "DensityWeight", "Depth",
	 "DepthExponent", "EffectiveLogDistance", "EffectiveTowedDistance", "Haul", "Individual",
