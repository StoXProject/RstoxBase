...
utils::globalVariables(c(
	 ...
	 "..columnsToKeep", "..extract", "..extractFromDataCopy", "..horizontalResolution",
	 "..haulGrouping", "..intervalVector", "..keys", "..keysSansSample", "..lengthInterval",
	 "..lengthIntervalWidths", "..lengthVar", "..locatedStratum", "..meanBy", "..mergeBy",
	 ...
	 "LengthGroup", "LengthResolution", "LogDuration", "LogKey", "LogOrigin", "Longitude",
	 ...
	 "ReplaceIndividual", "ReplaceIndividualIndex", "ReplaceLevel", "SSU", "SSUIndex", "Sample",
	 "SampleNumber", "SampleWeight", "SpeciesCategory", "SpeciesCategoryCatchWeight",
	 ...
	 "crossSection", "distance", "functionName", "getTrueCentroid", "ggtitle", "haulWeightFactor",
	 "imputeSeed", "includeintotal", "individualNumber", "individualWeightFactor", "inside",
	 "insideRadius", "intervalIndex", "median", "midIndividualTotalLength", "minDistance",
	 ...
	 "representativeBackscatteringCrossSectionNormalized", "setUnit", "sumIndividualWeightFactor",
