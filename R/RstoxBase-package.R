...
utils::globalVariables(c(
	 ...
	 "Distance", "DistanceSegment", "EDSU", "EffectiveLogDistance", "EffectiveTowDistance",
	 ...
	 "IndividualTotalLengthMiddle", "L1", "Latitude", "LatitudeEnd", "LatitudeStart", "Layer",
	 "LengthDistributionType", "LengthExponent", "LengthResolution", "LogDuration", "LogKey",
	 "LogOrigin", "Longitude", "LongitudeEnd", "LongitudeStart", "MaxChannelDepth",
	 "MaxChannelRange", "MeanNASCWeight", "MiddleDateTime", "MinChannelDepth", "MinChannelRange",
	 "NASCKey", "NASCWeight", "PSU", "PreySpeciesCategoryCatchWeightingFactor", "ReplaceIndividual",
	 "ReplaceIndividualIndex", "ReplaceLevel", "ReplaceStratumLayerIndividual",
