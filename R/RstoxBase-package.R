...
utils::globalVariables(c(
	 ...
	 "CruiseKey1", "CumulativeDistance", "DateTime", "Density", "DensityType", "DensityWeight",
	 "Depth", "DepthExponent", "Direction", "Distance", "DistanceTransect", "Duration", "EDSU",
	 "EffectiveLogDistance", "EffectiveTowDistance", "EstimationMethod", "Haul", "HaulKey",
