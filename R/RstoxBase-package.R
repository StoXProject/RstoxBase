...
utils::globalVariables(c(
	 ...
	 "..keysSansSample", "..lengthVar", "..locatedStratum", "..paddingVariables",
	 "..presentResolutionVariables", "..refvar", "..resolutionVar",
	 ...
	 "Cruise", "CruiseKey", "DateTime", "Density", "DensityWeight", "Depth", "DepthExponent",
	 "EDSU", "EffectiveLogDistance", "EffectiveTowDistance", "Haul", "Individual",
	 ...
	 "functionName", "haulWeightFactor", "imputeSeed", "individualCount", "inside", "intervalIndex",
	 "midDepth", "midIndividualTotalLength", "minDistance", "multiple", "packageName",
