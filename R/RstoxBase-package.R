...
utils::globalVariables(c(
	 ...
	 "EffectiveLogDistance", "EffectiveTowDistance", "Haul", "HaulKey", "Individual",
	 ...
	 "individualCount", "individualWeightFactor", "inside", "intervalIndex",
	 "midIndividualTotalLength", "minDistance", "multiple", "numberOfIndividuals",
	 "numberOfSubSamples", "packageName", "raisingFactor",
