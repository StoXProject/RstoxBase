...
utils::globalVariables(c(
	 ".", ".data", "..Cruise", "..DateTime", "..DensityType", "..FileGroupingVariables",
	 ...
	 "..haulGrouping", "..idCol", "..keys", "..keysSansSample", "..lengthInterval",
	 ...
	 "..tomerge", "..variablesToGetFromQuantityData", "..vars", "..x1y1x2y2", "Abundance",
	 ...
	 "ReplaceLevel", "ReplaceStratumLayerIndividual", "ReplaceStratumLayerIndividualIndex",
	 "RuterNavn", "SSU", "SSUIndex", "Sample", "SampleNumber", "SampleWeight", "SegmentType",
	 "SpeciesCategory", "SpeciesCategoryCatchWeight", "Speed", "SplitAcousticCategory",
	 ...
	 "TargetStrengthFunction", "TempLengthGroupUsedInSuperIndividuals", "TotalLength", "Transect",
	 "V1", "WeightedNumber", "WeightingFactor", "X", "Y", "approx", "area", "area_hole",
	 "assignmentID", "assignmentPasted", "backscatteringCrossSection", "cov", "crossSection",
	 "distance", "haulWeightFactor", "head", "imputeSeed", "includeintotal", "individualNumber",
	 "individualWeightFactor", "inside", "insideRadius", "intervalIndex", "km",
