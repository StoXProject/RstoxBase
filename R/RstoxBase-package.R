...
utils::globalVariables(c(
	 ...
	 "..horizontalResolution", "..idCol", "..keys", "..keysSansSample", "..lengthInterval",
	 ...
	 "..variablesToGetFromQuantityData", "..vars", "..x1x2y1y2", "Abundance", "AcousticCategory",
	 ...
	 "Sample", "SampleNumber", "SampleWeight", "SpatialHauls", "SpeciesCategory",
	 "SpeciesCategoryCatchWeight", "SplitAcousticCategory", "StartDateTime", "Station",
	 "StationLevel", "StopDateTime", "Stratum", "StratumPolygon", "SummedWeights", "Survey",
	 "SweepWidth", "TableName", "TargetStrength", "TargetStrength0", "TargetStrengthFunction",
	 ...
	 "insideRadius", "intervalIndex", "lenght", "median", "midIndividualTotalLength", "minDistance",
	 ...
	 "representativeBackscatteringCrossSectionNormalized", "setUnit", "st_linestring", "st_sf",
	 "st_sfc", "sumArea", "sumIndividualWeightFactor", "sumWeightedNumber", "x", "y"))
