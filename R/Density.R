...
SweptAreaDensity <- function(
    ...
    #}
    if(!endsWith(MeanLengthDistributionData$Data$LengthDistributionType[1], "Normalized")) {
    ...
    if(startsWith(MeanLengthDistributionData$Data$LengthDistributionType[1], "SweepWidthCompensated")) {
